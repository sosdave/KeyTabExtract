...
def ktextract():
    ...
    if '00120020' in hex_encoded:
        print("[*] AES256-CTS-HMAC key found. Will attempt extraction.")
        aes256 = True
    else:
        print("[!] Unable to identify any AES256 hashes.")

    if '00110010' in hex_encoded:
        print("[*] AES128-CTS-HMAC-SHA1-96 hash discovered. Will attempt extraction.")
        aes128 = True
    else:
        print("[!] Unable to identify any AES128 hashes.")
